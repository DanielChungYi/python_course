...
for i in range(max_iter):
    num = 10**random.uniform(-2, -3)
    print (num)
    lr = str(num)
    subprocess.call(['python3', 'train.py','--data','data/coco_5cls.data','--cfg','cfg/yolov3-5cls.cfg','--batch-size','4','--epochs','10','--accumulate','8','--weights','weights/yolov3.weights','--transfer','--lr',lr,'--name',lr])
    count += 1
print(count)
